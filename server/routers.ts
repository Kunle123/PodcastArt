      ...
      .mutation(async () => {
        ...
        try {
          ...
          const templateColumns = [
            ...
            { name: 'customPositionX', sql: "ALTER TABLE templates MODIFY COLUMN customPositionX VARCHAR(32) DEFAULT '0.25'" },
            { name: 'customPositionY', sql: "ALTER TABLE templates MODIFY COLUMN customPositionY VARCHAR(32) DEFAULT '0.25'" },
